...
; @FilePath: \asm_matrix_benchmark\src\assembly\windows\float\determinant_matrix_float.asm
; @Description: determinant matrix float nasm code on windows
; -------------------------------------------------------------

global determinant_float
extern puts
extern malloc
extern free
...
loop_copy:
    ...
    cvtss2sd xmm0, [r12 + rdx * 4]      ; convert float to double
    movsd [rbx + rdx * 8], xmm0         ; data[i] = (double)m->data[i]
