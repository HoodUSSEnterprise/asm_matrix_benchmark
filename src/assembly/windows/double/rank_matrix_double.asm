...
; @LastEditTime: 2026-06-26 15:21:10
; @FilePath: \asm_matrix_benchmark\src\assembly\windows\double\rank_matrix_double.asm
; @Description:  rank matrix double nasm code on windows
; -------------------------------------------------------------
...
loop_copy:
    ...
    movsd xmm0, [r12 + rdx * 8]         ; xmm0 = m->data[i]
