...
; @LastEditTime: 2026-06-26 15:20:59
; @FilePath: \asm_matrix_benchmark\src\assembly\windows\double\lu_matrix_double.asm
...
LU_Decomposition_double:
    ...
    ; ========== get leading minors ==========
    mov rcx, r14
    call get_leading_minors_double
    test rax, rax
...
check_lm_loop:
    ...
    imul rcx, 24                        ; rcx = i * sizeof(MatrixDouble)
