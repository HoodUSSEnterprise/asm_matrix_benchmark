...
; @LastEditTime: 2026-06-26 15:21:21
; @FilePath: \asm_matrix_benchmark\src\assembly\windows\double\special_matrix_double.asm
...
identity_matrix_double:
    ...
    mov r8, rdi                         ; number sizeof double
    shl r8, 3                           ; sizeof res data
    call memset
...
loopidentity:
    ...
    ; means res->data[i][i]
    movsd [rsi + r8 * 8], xmm0          ; res->data[i * order + i] = 1.0
    inc rdi
    jmp loopidentity
...
loopdiag:
    ...
    movsd [rsi + r8 * 8], xmm0          ; res->data[i * len + i] = data[i]
    inc rdi
    jmp loopdiag
...
loopeye:
    ...
    movsd [rsi + r8 * 8], xmm0          ; res->data[i * cols + i] = 1.0
    inc rdi
    jmp loopeye
