...
; @LastEditTime: 2026-06-28 15:56:30
; @FilePath: \asm_matrix_benchmark\src\assembly\windows\int\mul_fraction.asm
; @Description: mul fraction nasm code on windows
; -------------------------------------------------------------
...
mul_fraction:
    ...
    imul r14d, [r13]                    ; r14d *= f2->x (up)

    mov r15d, [r12 + 4]                 ; r15d = f1->y
    imul r15d, [r13 + 4]                ; r15d *= f2->y (down)
