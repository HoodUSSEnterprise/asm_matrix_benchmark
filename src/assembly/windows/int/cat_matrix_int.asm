...
; @LastEditTime: 2026-06-26 15:22:23
; @FilePath: \asm_matrix_benchmark\src\assembly\windows\int\cat_matrix_int.asm
...
loop1:
    ...
    loop2:
        ...
        imul r9, rcx                    ; r9 *= i
        add r9, rdx                     ; r9 += j
        mov r10d, [r14 + r9 * 4]        ; r10d = m1->data[i * res->cols + j]
        mov [rsi + r9 * 4], r10d
        inc rdx                         ; j++
        jmp loop2
    ...
    matrix_after1:
        ...
        add r9, rdx                     ; r9 += j
        mov r10d, [r15 + r9 * 4]        ; r10d = m1->data[(i - m1->rows) * res->cols + j]
        mov [rsi + r13 * 4], r10d
        inc rdx                         ; j++
        jmp loop2
...
loop11:
    ...
    loop21:
        ...
        imul r9, rcx                    ; r9 *= i
        add r9, rdx                     ; r9 += j
        mov r10d, [r14 + r9 * 4]        ; r10d = m1->data[i * m1->cols + j]
        mov r9, r12                     ; r9 = res->cols
        imul r9, rcx                    ; r9 *= i
        add r9, rdx                     ; r9 += j
        mov [rsi + r9 * 4], r10d        ; res->data[i * res->cols + j] = r10d
        inc rdx                         ; j++
        jmp loop21
    ...
    matrix_after11:
        ...
        mov r10d, [r15 + r9 * 4]        ; r10d = m2->data[i * m2->cols + j - m1->cols]
        mov r9, r12                     ; r9 = res->cols
        imul r9, rcx                    ; r9 *= i
        add r9, rdx                     ; r9 += j
        mov [rsi + r9 * 4], r10d
