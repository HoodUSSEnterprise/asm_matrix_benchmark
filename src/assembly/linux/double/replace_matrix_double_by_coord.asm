...
; @LastEditTime: 2026-06-26 15:15:43
; @FilePath: \asm_matrix_benchmark\src\assembly\linux\double\replace_matrix_double_by_coord.asm
; @Description: replace matrix double by coord nasm code on linux
; -------------------------------------------------------------
...
; rdi = m, rsi = pos, xmm0 = new_data (System V: 3rd param -> XMM0)
...
replace_matrix_double_by_coord:
    ...
    mov r14, rdi                        ; r14 = m
    mov r15, rsi                        ; r15 = pos
    movsd xmm15, xmm0                   ; xmm15 = new_data
