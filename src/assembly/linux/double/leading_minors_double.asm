...
; @Date: 2026-06-24 20:36:35
; @LastEditors: HoodUSSEnterprise
; @LastEditTime: 2026-06-26 15:14:09
; @FilePath: \asm_matrix_benchmark\src\assembly\linux\double\leading_minors_double.asm
; @Description: get leading principal minor double nasm code on linux
; -------------------------------------------------------------
...
get_leading_minors_double:
    ...
    mov rdi, 16                         ; sizeof(Leading_Minors_Double)
    call malloc wrt ..plt
    test rax, rax
...
malloc_fail_subdata:
    ...
    free_subdata_loop:
        ...
        mov r8, [r12 + rax]             ; r8 = matrix_data[i].data
        test r8, r8
