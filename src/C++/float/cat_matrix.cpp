...
@LastEditTime: 2026-06-26 09:02:30
@FilePath: \asm_matrix_benchmark\src\C++\float\cat_matrix.cpp
...
@return {*}
*************************************************************/
MatrixFloat MatrixFloat::cat(const MatrixFloat &other, int axis) const
{
    ...
    if (axis == 0)
    {
        ...
        MatrixFloat res(rows + other.rows, cols);
