...
@LastEditTime: 2026-06-26 09:03:35
@FilePath: \asm_matrix_benchmark\src\C++\float\constructor_matrix.cpp
...
@return {*}
*************************************************************/
MatrixFloat::MatrixFloat() : rows(0), cols(0), data() {}
...
@return {*}
*************************************************************/
MatrixFloat::MatrixFloat(size_t r, size_t c) : rows(r), cols(c), data(r * c, 0) {}
...
@return {*}
*************************************************************/
MatrixFloat::MatrixFloat(const float *arr, size_t r, size_t c) : rows(r), cols(c), data(r * c, 0)
{
...
@param {MatrixFloat} &other
@return {*}
*************************************************************/
MatrixFloat::MatrixFloat(const MatrixFloat &other) : rows(other.rows), cols(other.cols), data(other.data) {}
...
@return {*}
*************************************************************/
MatrixFloat::MatrixFloat(MatrixFloat &&other) noexcept
...
@return {*}
*************************************************************/
MatrixFloat &MatrixFloat::operator=(MatrixFloat &&other) noexcept
{
    if (this != &other)
    {
        rows = other.rows;
...
@return {*}
*************************************************************/
float &MatrixFloat::operator()(size_t i, size_t j)
{
...
@return {*}
*************************************************************/
const float &MatrixFloat::operator()(size_t i, size_t j) const
{
    return data[i * cols + j];
}
