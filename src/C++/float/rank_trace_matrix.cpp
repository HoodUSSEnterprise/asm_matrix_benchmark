...
@LastEditTime: 2026-06-26 09:06:36
@FilePath: \asm_matrix_benchmark\src\C++\float\rank_trace_matrix.cpp
...
size_t MatrixFloat::rank() const
{
    ...
    // Convert to double-precision 2D vector for Gaussian elimination
