...
@LastEditTime: 2026-06-26 08:49:16
@FilePath: \asm_matrix_benchmark\src\C++\double\extract_matrix.cpp
...
@return {*}
*************************************************************/
MatrixDouble MatrixDouble::extract_row(size_t row_idx) const
{
    if (row_idx >= rows)
    {
...
@return {*}
*************************************************************/
MatrixDouble MatrixDouble::extract_col(size_t col_idx) const
{
    if (col_idx >= cols)
    {
...
*************************************************************/
MatrixDouble MatrixDouble::extract_submatrix(size_t r_start, size_t r_end, size_t c_start, size_t c_end) const
{
