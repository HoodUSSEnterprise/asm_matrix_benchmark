...
@LastEditTime: 2026-06-29 13:53:14
@FilePath: \asm_matrix_benchmark\src\C++\double\lu_matrix.cpp
@Description:LU decomposition for MatrixDouble (C++ version)
*************************************************************/
...
*************************************************************/
std::vector<MatrixDouble> MatrixDouble::LU_Decomposition()
{
    // Check square
    if (rows != cols)
    {
