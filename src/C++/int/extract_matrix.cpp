...
@LastEditTime: 2026-06-26 08:56:32
@FilePath: \asm_matrix_benchmark\src\C++\int\extract_matrix.cpp
...
@return {*}
*************************************************************/
MatrixInt MatrixInt::extract_row(size_t row_idx) const
{
    if (row_idx >= rows)
    {
...
@return {*}
*************************************************************/
MatrixInt MatrixInt::extract_col(size_t col_idx) const
{
    if (col_idx >= cols)
    {
...
*************************************************************/
MatrixInt MatrixInt::extract_submatrix(size_t r_start, size_t r_end, size_t c_start, size_t c_end) const
{
