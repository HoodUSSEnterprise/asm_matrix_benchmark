...
int main(void)
{
    ...
    if (replace_matrix_double_by_coord(&replace_matrix, &replace_pos, 10))
    {
    ...
    double old_data = 7;
    double new_data = 10;
    if (replace_matrix_double_by_value(&replace_matrix, old_data, new_data))
    {
        print_matrix_double(&replace_matrix);
    }
    else
    {
        printf("%lf has not in matrix\n", old_data);
    }
    old_data = 20;
    if (replace_matrix_double_by_value(&replace_matrix, old_data, new_data))
    {
    ...
    puts("----------------------------------------------------------------------------------------");
    puts("-------------------------------------rank and trace-------------------------------------");
    double rank_data[9] = {1, 2, 3, 4, 5, 6, 7, 8, 9};
    ...
    if (trace_matrix_double(&trace_matrix, &trace))
    {
        ...
        printf("matrix trace = %lf \n", trace);
    }
    puts("----------------------------------------------------------------------------------------");
    puts("-------------------------------------compare matrix-------------------------------------");
    double compare_data1[6] = {1, 2, 3, 4, 5, 6};
    double compare_data2[6] = {6, 5, 4, 3, 2, 1};
    ...
    double inv_data[9] = {1, 2, 3, 0, 4, 5, 1, 0, 6};
    MatrixDouble matrix_origin = {inv_data, 3, 3};
    MatrixDouble *matrix_inv = inv_matrix_double(&matrix_origin);
    print_matrix_double(matrix_inv);
    puts("----------------------------------------------------------------------------------------");
    puts("-------------------------------------leading minors-------------------------------------");
    double leading_data[9] = {1, 2, 3, 4, 5, 6, 7, 8, 9};
    ...
    double lu_data[9] = {1, 2, 3, 0, 4, 5, 1, 0, 6};
    ...
    puts("----------------------------------------------------------------------------------------");
    puts("-------------------------------------extract matrix--------------------------------------");
    double extract_data[6] = {1, 2, 3, 4, 5, 6};
    ...
    puts("extract diag: ");
    double *extract_diag = extract_diag_double(&extract_matrix);
    for (size_t i = 0; i < 2; i++)
    {
        printf("%lf ", extract_diag[i]);
    }
    puts("");
    puts("----------------------------------------------------------------------------------------");
    puts("-------------------------------------random matrix---------------------------------------");
